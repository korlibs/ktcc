(function (root, factory) {
  ...
  function Runtime(REQUESTED_HEAP_SIZE, REQUESTED_STACK_PTR, __syscalls) {
    ...
    this.HEAP_cqsjxk$_0 = new Int8Array(this.HEAP_SIZE);
  }
  Runtime.prototype.lb_za3lpa$ = function (ptr) {
    return this.HEAP_cqsjxk$_0[ptr];
  };
  Runtime.prototype.sb_6t1wet$ = function (ptr, value) {
    this.HEAP_cqsjxk$_0[ptr] = value;
  };
  ...
  Runtime.prototype.memset_ox1na$ = function (ptr, value, num) {
    var tmp$;
    fill(this.HEAP_cqsjxk$_0, toByte(value), ptr.ptr, ptr.ptr + num | 0);
    return Kotlin.isType(tmp$ = ptr, CPointer) ? tmp$ : throwCCE();
  };
  Runtime.prototype.memmove_s2dlr0$ = function (dest, src, num) {
    arrayCopy(this.HEAP_cqsjxk$_0, this.HEAP_cqsjxk$_0, dest.ptr, src.ptr, src.ptr + num | 0);
    return dest;
  };
  Runtime.prototype.memcpy_s2dlr0$ = function (dest, src, num) {
    return this.memmove_s2dlr0$(dest, src, num);
  };
  Runtime.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'Runtime',
  ...
  AbstractRuntime.prototype.addPtr_rfeyu7$ = defineInlineFunction('ktcc.AbstractRuntime.addPtr_rfeyu7$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
  ...
  AbstractRuntime.prototype.strlenz_9h7eqk$ = function ($receiver) {
    var tmp$;
    tmp$ = 2147483647;
    for (var n = 0; n < tmp$; n++)
      if (this.get_qm71fq$($receiver, n) === toByte(0))
        return 0;
    return 2147483647;
  };
  AbstractRuntime.prototype.readStringz_9h7eqk$ = function ($receiver) {
    var tmp$;
    var sb = new AbstractRuntime$ByteArrayBuilder(this.strlenz_9h7eqk$($receiver));
  ...
  AbstractRuntime.prototype.fixedArrayOfByte_bn4j0w$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfByte_bn4j0w$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
  ...
  AbstractRuntime.prototype.fixedArrayOfShort_n9llk0$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfShort_n9llk0$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
  ...
  AbstractRuntime.prototype.fixedArrayOfInt_l2mvar$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfInt_l2mvar$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
  ...
  AbstractRuntime.prototype.fixedArrayOfLong_4hddq4$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfLong_4hddq4$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
  ...
  AbstractRuntime.prototype.fixedArrayOfUByte_la2grl$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfUByte_la2grl$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
      var $receiver = new CPointer_init(this.alloca_zero_za3lpa$(size * 1 | 0).ptr);
      setItems($receiver);
  ...
  AbstractRuntime.prototype.fixedArrayOfUShort_8mtrgx$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfUShort_8mtrgx$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
      var $receiver = new CPointer_init(this.alloca_zero_za3lpa$(size * 2 | 0).ptr);
      setItems($receiver);
  ...
  AbstractRuntime.prototype.fixedArrayOfUInt_ujryyq$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfUInt_ujryyq$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
      var $receiver = new CPointer_init(this.alloca_zero_za3lpa$(size * 4 | 0).ptr);
      setItems($receiver);
  ...
  AbstractRuntime.prototype.fixedArrayOfULong_55kk0l$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfULong_55kk0l$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
      var $receiver = new CPointer_init(this.alloca_zero_za3lpa$(size * 8 | 0).ptr);
      setItems($receiver);
  ...
  AbstractRuntime.prototype.set_ens9ex$ = defineInlineFunction('ktcc.AbstractRuntime.set_ens9ex$', function ($receiver, offset, value) {
    this.swf_24o109$($receiver.ptr + (offset * 4 | 0) | 0, value);
  });
  AbstractRuntime.prototype.get_value_s8tvni$ = defineInlineFunction('ktcc.AbstractRuntime.get_value_s8tvni$', function ($receiver) {
    return this.lwf_za3lpa$($receiver.ptr + (0 * 4 | 0) | 0);
  });
  AbstractRuntime.prototype.set_value_ydugf$ = defineInlineFunction('ktcc.AbstractRuntime.set_value_ydugf$', function ($receiver, value) {
  ...
  AbstractRuntime.prototype.fixedArrayOfFloat_tyyphc$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfFloat_tyyphc$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
      var $receiver = new CPointer_init(this.alloca_zero_za3lpa$(size * 4 | 0).ptr);
      setItems($receiver);
  ...
  AbstractRuntime.prototype.fixedArrayOfDouble_1u5i9l$ = defineInlineFunction('ktcc.AbstractRuntime.fixedArrayOfDouble_1u5i9l$', wrapFunction(function () {
    var CPointer_init = _.CPointer;
    return function (size, setItems) {
      var $receiver = new CPointer_init(this.alloca_zero_za3lpa$(size * 4 | 0).ptr);
      setItems($receiver);
  ...
  CLI.prototype.main_kand9s$ = function (args) {
    ...
    while (!argsReader.eof) {
      ...
      if (setOf(['-?', '/?', '-h', '-H']).contains_11rb$(v))
        ...
        compileOnly = true;
      else if (equals(v, '--runtime'))
        runtime = true;
      else if (equals(v, '--no-runtime'))
        runtime = false;
      else if (startsWith(v, '--subtarget='))
        subTarget = removePrefix(v, '--subtarget=');
      else if (startsWith(v, '--visibility='))
        visibility = removePrefix(v, '--visibility=');
    ...
    if (preprocessOnly) {
      ...
      tmp$_2 = subTarget != null ? subTarget : execute ? 'jvm' : 'common';
      var finalKtSource = ckEval.generateKotlinCodeWithRuntime_wpp9nl$(finalCSource, tmp$_4.copy_6o7ipo$(void 0, (tmp$_3 = visibility != null ? visibility : finalCOutput.info.visibility) != null ? tmp$_3 : 'public', void 0, void 0, void 0, void 0, tmp$_2, tmp$_1));
      if (!execute || print) {
        if (outputFile != null) {
  ...
  CCompiler.prototype.preprocess_ji1ias$ = function (sourceFiles, defines, includeFolders, optimizeLevel, fileReader) {
    ...
    return new PreprocessOutput(joinToString(plus(cSources, destination_1), '\n'), gctx.info().copy_6o7ipo$(void 0, void 0, void 0, void 0, void 0, toList_0(nativeIncludes)));
  };
  ...
  CKotlinEvaluator.prototype.generateKotlinCodeRaw_wpp9nl$ = function (cprogram, info) {
    ...
    return replace(this.target.generator_mvu3bg$(program(parser), parser, info).generate_dqye30$(true, info.runtime), 'public/*!*/ ', ((tmp$ = info.visibility) != null ? tmp$ : 'public') + ' ');
  };
  ...
  BaseGenerator.prototype.generate_dqye30$$default = function (includeErrorsInSource, includeRuntime) {
    ...
    this.generateFixedSizeArrayTypesOutside_rzrydj$($receiver);
    if (mainFunc != null) {
  ...
  function BaseGenerator$generate$lambda(closure$it, this$BaseGenerator) {
    return function ($receiver) {
      var tmp$;
      tmp$ = closure$it.stms.iterator();
      while (tmp$.hasNext()) {
        var s = tmp$.next();
        this$BaseGenerator.generate_ghgxvp$($receiver, s);
      }
      return Unit;
    };
  }
  ...
  BaseGenerator.prototype.generateFixedSizeArrayTypesOutside_rzrydj$ = function ($receiver) {
  };
  ...
  BaseGenerator.prototype.genFuncDeclaration_m2wx6w$ = function ($receiver, it, block) {
    this.numAllocs = 0;
    $receiver.line_61zpoe$(this.get_str_cpakq9$(this.resolve_cpakq9$(it.funcType.retType)) + ' ' + it.name.name + '(' + joinToString(it.paramsWithVariadic, ', ', void 0, void 0, void 0, void 0, BaseGenerator$genFuncDeclaration$lambda(this)) + ')' + ' {');
    var $receiver_0 = $receiver.cmds;
    var element = Indenter_0.Indent;
    $receiver_0.add_11rb$(element);
    try {
  ...
  function BaseGenerator$generate$lambda$lambda_0(closure$it, this$BaseGenerator, this$) {
    return function () {
      ...
      while (tmp$_0.hasNext()) {
        ...
        this$.line_61zpoe$('// Require alloc in stack to get pointer: ' + symbol);
      }
      ...
      if (func.hasGoto && !this$BaseGenerator.supportsGoto) {
        ...
        while (tmp$_2.hasNext()) {
          ...
          this$BaseGenerator.generate_ghgxvp$(this$, decl);
        }
        this$.line_61zpoe$('__smLabel = -1');
        var $this = this$;
        ...
        try {
          ...
          this$_0.line_61zpoe$('when (__smLabel)' + ' {');
          var $receiver_1 = this$_0.cmds;
          var element_0 = Indenter_0.Indent;
          $receiver_1.add_11rb$(element_0);
          try {
            var tmp$_7;
            this$_0.line_61zpoe$('-1 -> {');
            var $receiver_2 = this$_0.cmds;
            var element_1 = Indenter_0.Indent;
            $receiver_2.add_11rb$(element_1);
            tmp$_7 = output.stms.iterator();
            while (tmp$_7.hasNext()) {
              var stm = tmp$_7.next();
              this$BaseGenerator_0.generate_ghgxvp$(this$_0, stm);
            }
            var $receiver_3 = this$_0.cmds;
            var element_2 = Indenter_0.Unindent;
            $receiver_3.add_11rb$(element_2);
            this$_0.line_61zpoe$('}');
          }finally {
        ...
        while (tmp$_3.hasNext()) {
          ...
          this$BaseGenerator.generate_ghgxvp$(this$, stm_0);
        }
      }
      return Unit;
    };
  }
  function BaseGenerator$generate$lambda_3(closure$it, this$BaseGenerator) {
    return function ($receiver) {
      this$BaseGenerator.functionScope_klfg04$(BaseGenerator$generate$lambda$lambda_0(closure$it, this$BaseGenerator, $receiver));
      return Unit;
    };
  }
  BaseGenerator.prototype.generate_l04ho8$ = function ($receiver, it, isTopLevel) {
    this.displayComments_2e9wgm$($receiver, it);
    this.genFuncDeclaration_m2wx6w$($receiver, it, BaseGenerator$generate$lambda_3(it, this));
  };
  function BaseGenerator$generate$lambda_4(closure$init, closure$varInit2, closure$varType) {
    return function () {
      if (closure$varInit2 == null && Kotlin.isType(closure$varType, ArrayType))
        return new ArrayInitExpr(listOf(new DesignOptInit(null, IntConstant(0))), closure$init.type);
      else if (closure$varInit2 != null)
        return closure$varInit2;
      else
        return closure$varInit2;
    };
  }
  ...
  function BaseGenerator$generate$lambda_6(closure$varType, this$BaseGenerator, closure$varInitStr, closure$varInit) {
    return function () {
      var tmp$ = Kotlin.isType(closure$varType, StructType);
      if (tmp$) {
        tmp$ = !Kotlin.isType(closure$varInit.value, ArrayInitExpr);
      }
      if (tmp$) {
  ...
  BaseGenerator.prototype.generate_bbgvzo$$default = function ($receiver, it, isTopLevel, isStaticTopLevel, isStaticPrefix) {
    ...
    if (!it.specifiers.hasTypedef) {
      ...
      while (tmp$.hasNext()) {
        ...
        var varInit = lazy(BaseGenerator$generate$lambda_4(init, varInit2, varType));
        var varInitStr = lazy(BaseGenerator$generate$lambda_5(varInit, varType, this, init));
        var varInitStr2 = lazy(BaseGenerator$generate$lambda_6(varType, this, varInitStr, varInit));
  ...
  BaseGenerator.prototype.generateAssign_oumrkp$ = function (l, r) {
    ...
    if (Kotlin.isType(l, ArrayAccessExpr)) {
      var lexpr = l.expr;
      var index = this.generate_o41f6z$(l.index, false);
  ...
  KotlinGenerator.prototype.lineStackFrame_a1gkqt$$default = function ($receiver, node, alreadyInBlock, code) {
    ...
    code($receiver_0);
    var indentedCode = $receiver_0.toString();
    var blockAllocs = this.numAllocs;
    this.numAllocs = oldAllocs;
  ...
  KotlinGenerator.prototype.generate_vu1aa4$$default = function ($receiver, par) {
    ...
    if (Kotlin.isType(ltype, StructType)) {
      ...
      while (tmp$_2.hasNext()) {
        ...
        var tmp$_3;
        var pair = to(element.name, (tmp$_3 = inits.get_11rb$(element.name)) != null ? tmp$_3 : this.defaultValue_cpakq9$(element.type));
  ...
  KotlinGenerator.prototype.genFuncDeclaration_m2wx6w$ = function ($receiver, it, block) {
    this.numAllocs = 0;
    var $receiver_0 = new Indenter_0();
    block($receiver_0);
    var body = $receiver_0.toString();
    var allocs = this.numAllocs;
    var stackFrame = allocs > 0 ? ' = stackFrame' : '';
    $receiver.line_61zpoe$('fun ' + it.name.name + '(' + joinToString(it.paramsWithVariadic, ', ', void 0, void 0, void 0, void 0, KotlinGenerator$genFuncDeclaration$lambda(this)) + '): ' + this.get_str_cpakq9$(this.resolve_cpakq9$(it.funcType.retType)) + stackFrame + ' {');
    var $receiver_1 = $receiver.cmds;
    var element = Indenter_0.Indent;
    $receiver_1.add_11rb$(element);
    try {
  ...
  KotlinGenerator.prototype.generateStructuresBase_eec6ek$ = function ($receiver, kind) {
    ...
    while (tmp$.hasNext()) {
      ...
      if (kind) {
        ...
        $receiver.line_61zpoe$('inline fun fixedArrayOf' + typeName + '(size: Int, setItems: CPointer<' + typeName + '>.() -> Unit): CPointer<' + typeName + '> = alloca_zero(size * ' + typeSize + ').toCPointer<' + typeName + '>().apply(setItems)');
        ...
        $receiver.line_61zpoe$('@get:' + JvmName + '(' + '"' + 'get' + typeName + '"' + ') var CPointer<' + typeName + '>.' + this.get_valueProp_cpakq9$(type.type) + ': ' + typeName + ' get() = this[0]; set(value) { this[0] = value }');
        ...
        while (tmp$_0.hasNext()) {
          ...
          if (Kotlin.isType(ftype, PrimType)) {
            ...
            $receiver.line_61zpoe$(base + ' get() = ' + this.get_str_cpakq9$(ftype) + '(' + addr + '); set(value) { TODO(' + '"' + 'Unsupported setting ftype=' + ftype + '"' + ') }');
          else
  ...
  KotlinGenerator.prototype.generateFixedSizeArrayTypes_rzrydj$ = function ($receiver) {
    this.generateFixedSizeArrayTypesBase_eec6ek$($receiver, false);
  };
  KotlinGenerator.prototype.generateFixedSizeArrayTypesOutside_rzrydj$ = function ($receiver) {
    this.generateFixedSizeArrayTypesBase_eec6ek$($receiver, true);
  };
  function KotlinGenerator$generateFixedSizeArrayTypesBase$addr(index) {
    return 'addr(' + index + ')';
  }
  KotlinGenerator.prototype.generateFixedSizeArrayTypesBase_eec6ek$ = function ($receiver, kind) {
    var tmp$, tmp$_0;
    ...
    while (tmp$.hasNext()) {
      ...
      if (kind) {
        ...
        else if (Kotlin.isType(elementType, StructType) || Kotlin.isType(elementType, ArrayType))
  ...
  function UIntConstant(value) {
    return new IntConstant_3(value.toString(), Type$Companion_getInstance().UINT);
  }
  function IntConstant(value) {
    return IntConstant_1(value.toString());
  }
  function LongConstant(value) {
    return new IntConstant_3(value.toString(), Type$Companion_getInstance().LONG);
  }
  function ULongConstant(value) {
    return new IntConstant_3(value.toString(), Type$Companion_getInstance().ULONG);
  }
  function IntConstant_0(value, type) {
    if (type === void 0)
      type = Type$Companion_getInstance().LONG;
    return new IntConstant_3(value.toString(), type);
  }
  ...
  function DecimalConstant(value, type) {
    if (type === void 0)
      type = Type$Companion_getInstance().DOUBLE;
    return new DecimalConstant_0(value.toString(), type);
  }
  function DoubleConstant(value) {
    return new DecimalConstant_0(value.toString(), Type$Companion_getInstance().DOUBLE);
  }
  function FloatConstant(value) {
    return new DecimalConstant_0(value.toString(), Type$Companion_getInstance().FLOAT);
  }
  function DecimalConstant_0(data, type) {
    DecimalConstant$Companion_getInstance();
    if (type === void 0)
      type = endsWith_0(data, 'f') ? Type$Companion_getInstance().FLOAT : Type$Companion_getInstance().DOUBLE;
    NumericConstant.call(this);
    this.data = data;
    this.type_vkehl3$_0 = type;
  ...
  DecimalConstant$Companion.prototype.isValidMsg_61zpoe$ = function (data) {
    if (startsWith(data, '-')) {
      return this.isValidMsg_61zpoe$(data.substring(1));
    }
    var $receiver = new CharRange(48, 57);
    var element = firstOrNull(data);
  ...
  DecimalConstant_0.prototype.component2 = function () {
    return this.type;
  };
  DecimalConstant_0.prototype.copy_1t4lez$ = function (data, type) {
    return new DecimalConstant_0(data === void 0 ? this.data : data, type === void 0 ? this.type : type);
  };
    ...
    callback$break: do {
      ...
      switch ($receiver.peek_za3lpa$()) {
        ...
        case '!':
          ...
          if ((equals(op_0, '+') || equals(op_0, '-')) && Kotlin.isType(expr_1, NumericConstant)) {
            if (equals(op_0, '-')) {
  ...
  function PreprocessorInfo(moduleName, visibility, packageName, runtimeClass, constantDecls, nativeIncludes, subTarget, runtime) {
  ...
  PreprocessorInfo.prototype.component8 = function () {
    return this.runtime;
  };
  PreprocessorInfo.prototype.copy_6o7ipo$ = function (moduleName, visibility, packageName, runtimeClass, constantDecls, nativeIncludes, subTarget, runtime) {
    return new PreprocessorInfo(moduleName === void 0 ? this.moduleName : moduleName, visibility === void 0 ? this.visibility : visibility, packageName === void 0 ? this.packageName : packageName, runtimeClass === void 0 ? this.runtimeClass : runtimeClass, constantDecls === void 0 ? this.constantDecls : constantDecls, nativeIncludes === void 0 ? this.nativeIncludes : nativeIncludes, subTarget === void 0 ? this.subTarget : subTarget, runtime === void 0 ? this.runtime : runtime);
  };
  PreprocessorInfo.prototype.toString = function () {
    return 'PreprocessorInfo(moduleName=' + Kotlin.toString(this.moduleName) + (', visibility=' + Kotlin.toString(this.visibility)) + (', packageName=' + Kotlin.toString(this.packageName)) + (', runtimeClass=' + Kotlin.toString(this.runtimeClass)) + (', constantDecls=' + Kotlin.toString(this.constantDecls)) + (', nativeIncludes=' + Kotlin.toString(this.nativeIncludes)) + (', subTarget=' + Kotlin.toString(this.subTarget)) + (', runtime=' + Kotlin.toString(this.runtime)) + ')';
  };
  ...
  PreprocessorInfo.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.moduleName, other.moduleName) && Kotlin.equals(this.visibility, other.visibility) && Kotlin.equals(this.packageName, other.packageName) && Kotlin.equals(this.runtimeClass, other.runtimeClass) && Kotlin.equals(this.constantDecls, other.constantDecls) && Kotlin.equals(this.nativeIncludes, other.nativeIncludes) && Kotlin.equals(this.subTarget, other.subTarget) && Kotlin.equals(this.runtime, other.runtime)))));
  };
  ...
  PreprocessorGlobalContext.prototype.info = function () {
    return new PreprocessorInfo(this.moduleName, void 0, this.packageName, this.runtimeClass, toMap(this.constantDecls));
  };
                ...
                case 'ktcc':
                  ...
                  switch (ktccPragma) {
                    ...
                    case 'visibility':
                      ...
                      var tmp$_17;
                      tmp$_16.visibility = trim(Kotlin.isCharSequence(tmp$_17 = $receiver_6) ? tmp$_17 : throwCCE()).toString();
                      break;
                    case 'runtime':
                      var tmp$_18 = this.ctx.global;
                      var $receiver_7 = joinToString(drop(ptokens2, 1), '');
                      var tmp$_19;
  ...
  package$parser.UIntConstant_s87ys9$ = UIntConstant;
  package$parser.IntConstant_za3lpa$ = IntConstant;
  package$parser.LongConstant_s8cxhz$ = LongConstant;
  package$parser.ULongConstant_mpgczg$ = ULongConstant;
  package$parser.IntConstant_b059pb$ = IntConstant_0;
  ...
  package$parser.DecimalConstant_4qvbh1$ = DecimalConstant;
  package$parser.DoubleConstant_14dthe$ = DoubleConstant;
  package$parser.FloatConstant_mx4ult$ = FloatConstant;
